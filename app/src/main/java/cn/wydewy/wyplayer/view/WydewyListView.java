...
public class WydewyListView extends ListView implements OnScrollListener,
	...
	public WydewyListView(Context context) {
		super(context);
	...
	public WydewyListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		initDates(context);
		initView();
	...
	public WydewyListView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initView() {
		...
		// 长按相关初始化
		floatDialog = new FloatDialog(context, R.style.floatDialogStyle, this);
	...
	public SideClickListener getSideClickListener() {
		return sideClickListener;
	}

	public void setSideClickListener(SideClickListener sideClickListener) {
		this.sideClickListener = sideClickListener;
	}
