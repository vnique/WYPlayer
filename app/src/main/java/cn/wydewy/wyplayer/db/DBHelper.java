...
public class DBHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS " + DBData.MUSIC_TABLENAME
				...
				+ DBData.MUSIC_PATH + " NVARCHAR(300), " + DBData.MUSIC_URL
				+ " NVARCHAR(300), " + DBData.MUSIC_FOLDER + " NVARCHAR(300), "
				+ DBData.MUSIC_FAVORITE + " INTEGER, " + DBData.MUSIC_TIME
				+ " NVARCHAR(100), " + DBData.MUSIC_SIZE + " NVARCHAR(100), "
				+ DBData.MUSIC_ARTIST + " NVARCHAR(100), "
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS " + DBData.LYRIC_TABLENAME
				...
				+ DBData.LYRIC_TYPE + " NVARCHAR(300))");// wydewy
